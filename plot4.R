...
#SET PLOT WINDOW TO 2 x 2
par(mfrow=c(2,2))

#PLOT1 TOP LEFT
plot(datetime, sel_dat$Global_active_power, type = "l", xlab = "", 
     ylab = "Global Active Power")

#PLOT2 TOP RIGHT
plot(datetime, sel_dat$Voltage, type = "l", 
...
#PLOT4 BOTTOM RIGHT
plot(datetime, sel_dat$Global_reactive_power, type = "l", 
